...
entire course and final letter grade.
 ...
 Define and use a class for the student record. The class should have instance variables for the quizzes, midterm, final, overall numeric score for the course, and 
...
public class Main{
    ...
    public static void main(String[] args) {
        ...
        StudentRecord myGrade = new StudentRecord(8, 8, 8, 80, 80);
        StudentRecord yourGrade = new StudentRecord(8, 8, 8, 80, 80);
        StudentRecord otherGrade = new StudentRecord(5, 10, 10, 99, 99);


        System.out.println(myGrade.computeFinalGrade()); //works prints 80

        System.out.println(myGrade); // works, prints toString method 

        System.out.println(myGrade.equals(yourGrade)); // works, prints ture

        System.out.println(myGrade.equals(otherGrade)); // works, prints false
