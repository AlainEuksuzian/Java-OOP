...
Fahrenheit. The class should have four constructor methods: one for each instance variable (assume zero degrees if no value is specified and Celsius if no scale is specified), 
...
DegreesC = 5(degreesF - 32)/9 ======  degreeC/5*9 +32
DegreesF = (9(degreesC)/5) + 32;  =====  degreef/9*5 - 32
